    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php"><img src="https://i.ibb.co/NjLSv8x/lohedu-removebg-preview.png" width="300px"></img></a></div>
      ...
      <div class="container">
        ...
        <div class="row pt-1 mt-1 text-center">
          <div class="col-md-10">
            ...
            <p>
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved EduHome
      </p>
            </div>
          </div>
