...
<table class="table table-borderless" align="Center" >
  ...
  <tbody>
    <tr >
      <td class="mytable1" style="padding:80px">
      ...
      <td class="mytable2"  style="padding:80px">
      ...
      <td class="mytable2"  style="padding:80px">
         <div class="card shadow border-0" style="width: 15rem; height: 110px; box-shadow: 2px 2px #827171; border-radius:0px; border-top-left-radius: 0px;">
           ...
           <div class="card-body">
              <p class="card-text text-white"><b class="h4">No. Of Test</b><br><span style="font-size: 20px;"><?php $admin->display_test_count(); ?></span></p>
            </div>
